...
Open the live app in a mobile browser and use the browser's **Install app** or **Add to Home screen** option.

Lock-screen activities and reminders depend on browser, installed-app and notification support. Phone notification privacy settings also affect what appears on the lock screen.
