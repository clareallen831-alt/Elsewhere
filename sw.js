const CACHE='elsewhere-v36-green-brown-wool-coat';
const ASSETS=['./','./index.html','./styles.css','./app.js','./photos.js','./achievements.js','./achievements-base.js','./project-steps.js','./focus-cleanup.js','./food.js','./food-barcode.js','./food-extras.js','./food-favourites-v2.js','./food-favourite-quick.js','./backup.js','./recipe-calculator.js','./recipe-paste.js','./health-v2.js','./health-v2.css','./health-dates.js','./health-push-test.js','./phase4.js','./phase4.css','./fashion.js','./fashion-coat-colour.js','./fashion.css','./sewing-patterns.js','./illustrations/ui/nav-home.webp','./illustrations/ui/nav-food.webp','./illustrations/ui/nav-health.webp','./illustrations/ui/nav-fashion.webp','./illustrations/ui/nav-mylife.webp','./manifest.json','./icon.svg','./icon-elsewhere-v3.svg','./icon-elsewhere-v3-192.png','./icon-elsewhere-v3-512.png','./icon-elsewhere-v3-maskable-512.png'];
