const CACHE='elsewhere-v17-fashion';
const ASSETS=['./','./index.html','./styles.css','./app.js','./photos.js','./achievements.js','./achievements-base.js','./project-steps.js','./food.js','./food-extras.js','./backup.js','./recipe-calculator.js','./recipe-paste.js','./health-v2.js','./health-v2.css','./health-dates.js','./health-push-test.js','./phase4.js','./phase4.css','./fashion.js','./fashion.css','./manifest.json','./icon.svg','./icon-elsewhere-v3.svg','./icon-elsewhere-v3-192.png','./icon-elsewhere-v3-512.png','./icon-elsewhere-v3-maskable-512.png'];
